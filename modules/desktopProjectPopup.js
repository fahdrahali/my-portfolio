...
const addPrjectDetailsDesktopPopup = (project) => {
  ...
  const divPopupTech = document.createElement('div');
  divPopupTech.classList.add('popup-tech');
  ...
  popup.appendChild(sectionImg);
  popup.appendChild(sectionPopupContent);
...
export default addPrjectDetailsDesktopPopup;
